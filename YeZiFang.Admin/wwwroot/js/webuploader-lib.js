...
//相关变量
var $wrap, $queue, $statusBar, $info, $upload, $placeHolder, $progress,
    fileCount, fileSize, ratio, thumbnailWidth, thumbnailHeight, state,
    percentages, flashVersion, supportTransition, uploader;
