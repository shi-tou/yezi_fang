...
namespace YeZiFang.App.Service
{
    ...
    public interface IMongoService
    {
        ...
        /// <returns></returns>
        PagingList<T> PageList<T>(Hashtable hs, int pageIndex, int pageSize, string sortFiled = "", bool isAsc = false);
        /// <summary>
        /// 分页获取数据
        /// </summary>
        /// <param name="pageIndex">页索引</param>
        ...
        /// <param name="isAsc">是否升序</param>
        /// <returns></returns>
        PagingList<T> PageList<T>(int pageIndex, int pageSize, string sortFiled = "", bool isAsc = false);
    }
}
